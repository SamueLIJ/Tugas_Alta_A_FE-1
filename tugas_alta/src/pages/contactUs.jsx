      ...
      <div>
        ...
        <div className="position-absolute">
          <img
            src={logoAlta}
            alt="logo-alta"
            style={{ marginLeft: 100, marginTop: 250 }}
          />
        </div>
        <div className="container">
          <form onSubmit={handleSubmit} className="needs-validation" noValidate>
            <h1
              ...
              style={{ marginLeft: 450, fontSize: 50 }}
            >
              Contact Us
            </h1>
            <div
            ...
            >
              ...
              <select className="me-text" name="nationality">
                <option className="me-text2" value="selected" disabled>
                  Selected
                </option>
                <option className="me-text2" value="indonesian">
                  Indonesian
                </option>
                <option className="me-text2" value="united kingdom" selected>
                  United Kingdom
                </option>
            ...
            <div
              ...
              style={{ marginLeft: 450 }}
            >
              <label className="medium-text">Message</label>
              <br />
              <textarea
                name="message"
                id="message"
